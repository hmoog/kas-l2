...
use crate::{BatchRef, RuntimeState, VersionedState, storage::cmd::Write, vm::VM};

#[smart_pointer]
pub struct StateDiff<S: Store<StateSpace = RuntimeState>, V: VM> {
    batch: BatchRef<S, V>,
...
impl<S: Store<StateSpace = RuntimeState>, V: VM> StateDiff<S, V> {

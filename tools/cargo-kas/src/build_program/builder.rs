...
impl Builder {
    pub(crate) fn print_verbose(self) -> Result<Self> {
    ...
    pub(crate) fn create_target_directories(self) -> Result<Self> {
        fs::create_dir_all(&self.target_dir)?;
        fs::create_dir_all(&self.staging_dir)?;
        Ok(self)
    }

    pub(crate) fn build_sbf_artifacts(mut self) -> Result<Self> {
    ...
    pub(crate) fn stage_sbf_artifacts(mut self) -> Result<Self> {
        let sbf_roots = [self
            .workspace_root
    ...
    pub(crate) fn build_sp1_artifacts(mut self) -> Result<Self> {
    ...
    pub(crate) fn stage_sp1_artifacts(mut self) -> Result<Self> {
    ...
    pub(crate) fn pack_artifacts(self) -> Result<Self> {
